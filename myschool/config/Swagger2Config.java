package com.project.myschool.config;
...
public class Swagger2Config {
    ...
    public Docket webApiConfig(){
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.project.myschool.controller"))
                //过滤掉admin路径下的所有页面
    ...
    private ApiInfo webApiInfo(){
        ...
        return new ApiInfoBuilder()
                ...
                .description("")
                .version("1.0")
                .contact(new Contact("project", "", "c451735634@163.com"))
                .build();
    }
